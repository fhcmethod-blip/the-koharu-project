...
/** Placeholder catalog — swap URLs for your real IRL media once storage is wired. */
export const vaultItems: VaultItem[] = [
  ...
  },
  {
    id: "set-03",
    title: "Hotel window",
    description: "Travel set — city night reflections.",
    type: "photo",
    tierRequired: "free",
...
export function canAccess(userTier: MembershipTier, required: MembershipTier): boolean {
